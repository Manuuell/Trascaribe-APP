                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: _loading ? null : () {
                              final value = _ctr.text.trim();

                              // Expresión regular: uno o más dígitos
                              final soloDigitos = RegExp(r'^\d+$');

                              if (value.isEmpty || !soloDigitos.hasMatch(value)) {
                                setState(() => _error = 'Ingresa un número de tarjeta válido');
                                return;
                              }
                              _consultar();   // solo se llama si pasa la validación
                            },
                            style: ElevatedButton.styleFrom(
